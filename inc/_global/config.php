...
session_start();
error_reporting(0);
define("passgrowth",true);
require 'actionapp.php';
if($_SESSION['logauthis']==true){
    $proses_data = cekmail_akun(base64_decode($_SESSION['email']));
    $data_akun = mysqli_fetch_assoc($proses_data);
}
...
$cb                             = new Template('Growth', '1.0', 'assets');
...
$cb->title                      = 'Growth - Menghubungkan Pemodal dengan Petani';
$cb->description                = 'Growth - Bergabung bersama kami untuk membangun bangsa';
$cb->og_url_site                = '';
$cb->og_url_image               = '';
